...
#define NANITE_RENDER_FLAG_PROGRAMMABLE_RASTER				0x800
...
#define NANITE_RASTER_BIN_CLASSIFY_SW	0
#define NANITE_RASTER_BIN_CLASSIFY_HW	1
#define NANITE_RASTER_BIN_SCATTER_SW	2
#define NANITE_RASTER_BIN_SCATTER_HW	3
#define NANITE_RASTER_BIN_RESERVE		4
