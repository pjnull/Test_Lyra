...
private:
	 ...
	 */
	static void MakeNormalizationTransform(const FAxisAlignedBox3d& Bounds, FTransform3d& ToNormalizedOut, FTransform3d& FromNormalizedOut);
	 ...
	 */
	static FDynamicMesh3 AccumulateExtrusionVolumes(const TArray<AWaterBodyExclusionVolume*>& ExclusionVolumes, const FTransform3d& Transform);
