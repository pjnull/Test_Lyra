...
namespace UE::Online::Errors {
	...
	ONLINE_ERROR_CATEGORY(Windows, Engine, 0x2, "Windows")
	ONLINE_ERROR(Windows, Abort,			0x80004004,	TEXT("E_ABORT"),			LOCTEXT("E_ABORT", "Operation aborted"))
	ONLINE_ERROR(Windows, AccessDenied,		0x80070005, TEXT("E_ACCESSDENIED"),		LOCTEXT("E_ACCESSDENIED", "General access denied error"))
	ONLINE_ERROR(Windows, Fail,				0x80004005, TEXT("E_FAIL"),				LOCTEXT("E_FAIL", "Unspecified failure"))
	ONLINE_ERROR(Windows, Handle,			0x80070006, TEXT("E_HANDLE"),			LOCTEXT("E_HANDLE", "Handle that is not valid"))
	ONLINE_ERROR(Windows, InvalidArg,		0x80070057, TEXT("E_INVALIDARG"),		LOCTEXT("E_INVALIDARG", "One or more arguments are not valid"))
	ONLINE_ERROR(Windows, NoInterface,	 	0x80004002, TEXT("E_NOINTERFACE"),		LOCTEXT("E_NOINTERFACE", "No such interface supported"))
	ONLINE_ERROR(Windows, NotImpl, 			0x80004001, TEXT("E_NOTIMPL"),			LOCTEXT("E_NOTIMPL", "Not implemented"))
	ONLINE_ERROR(Windows, OutOfMemory, 		0x8007000E, TEXT("E_OUTOFMEMORY"),		LOCTEXT("E_OUTOFMEMORY", "Failed to allocate necessary memory"))
	ONLINE_ERROR(Windows, Pointer, 			0x80004003, TEXT("E_POINTER"),			LOCTEXT("E_POINTER", "Pointer that is not valid"))
	ONLINE_ERROR(Windows, Unexpected,	 	0x8000FFFF, TEXT("E_UNEXPECTED"),		LOCTEXT("E_UNEXPECTED", "Unexpected failure"))
