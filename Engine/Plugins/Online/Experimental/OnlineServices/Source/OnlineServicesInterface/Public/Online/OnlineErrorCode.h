...
#define ONLINE_ERROR_CATEGORY(Name, InSystem, Value, Description) \
...
#define ONLINE_ERROR_CATEGORY_RANGE(Name, System, StartValue, EndValue, Description) \
...
#define ONLINE_ERROR(CategoryName, Name, ErrorCodeValue, ErrorMessage, ErrorText) \
	...
	namespace CategoryName { \
		inline UE::Online::Errors::FOnlineError Name(const TOptional<UE::Online::Errors::FOnlineError>& Inner = TOptional<UE::Online::Errors::FOnlineError>()) \
		{ \
			TSharedPtr<UE::Online::Errors::FOnlineError, ESPMode::ThreadSafe> InnerPtr; \
			if (Inner) \
			{ \
				InnerPtr = MakeShared<UE::Online::Errors::FOnlineError, ESPMode::ThreadSafe>(Inner.GetValue()); \
			} \
			return UE::Online::Errors::FOnlineError( ErrorCode::Create(UE::Online::Errors::ErrorCode::Category::CategoryName##_System, UE::Online::Errors::ErrorCode::Category::CategoryName, ErrorCodeValue), MakeShared<UE::Online::Errors::FOnlineErrorDetails, ESPMode::ThreadSafe>(ErrorMessage, ErrorText), InnerPtr); \
		}\
	}
