...
} GConfigLayers[] =
{
	...
	**************************************************/
	...
	// Project/Custom/CustomConfig/Platform/Platform*.ini only if CustomConfig is defined
	{ TEXT("CustomConfigPlatform"),		TEXT("{PROJECT}/Config/Custom/{CUSTOMCONFIG}/{PLATFORM}/{PLATFORM}{TYPE}.ini"), EConfigLayerFlags::RequiresCustomConfig },
