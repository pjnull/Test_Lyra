...
BEGIN_GLOBAL_SHADER_PARAMETER_STRUCT(FPrimitiveUniformShaderParameters,ENGINE_API)
	...
	SHADER_PARAMETER(float,			MaxWPODistance)
...
#define PRIMITIVE_SCENE_DATA_FLAG_HAS_NANITE_IMPOSTER					0x8000
...
#define PRIMITIVE_SCENE_DATA_FLAG_EVALUATE_WORLD_POSITION_OFFSET		0x2000000
...
public:
	inline FPrimitiveUniformShaderParametersBuilder& Defaults()
	{
		...
		Parameters.MaxWPODistance					= 0.0f;
...
#undef PRIMITIVE_UNIFORM_BUILDER_METHOD
	...
	inline FPrimitiveUniformShaderParametersBuilder& MaxWorldPositionOffsetDistance(float InMaxDistance)
	{
		Parameters.MaxWPODistance = InMaxDistance;
		return *this;
	}
