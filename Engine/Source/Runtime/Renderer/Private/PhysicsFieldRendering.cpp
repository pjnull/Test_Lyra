...
class FPhysicsFieldRayMarchingCS : public FGlobalShader
{
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		SHADER_PARAMETER_SRV(FVector4, BoundsMin)
		SHADER_PARAMETER_SRV(FVector4, BoundsMax)
		SHADER_PARAMETER_SRV(float, NodesParams)
		SHADER_PARAMETER_SRV(int32, NodesOffsets)
		SHADER_PARAMETER_SRV(int32, TargetsOffsets)
